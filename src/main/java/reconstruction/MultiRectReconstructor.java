...
public class MultiRectReconstructor extends ShapeReconstructor {
	private AbstractBitmap resultImage;
	private AbstractCanvas mResultCanvas;
	 ...
	 */
	public MultiRectReconstructor(AbstractBitmap source, int maxRows,
	...
	public boolean giveNext(AbstractBitmap nextFragmentImage) {
		if (this.next != null 
			...
			if (this.resultImage == null) {
				...
				mResultCanvas = AbstractCanvasFactory.getInstance().makeCanvas(resultImage);
			}
	...
	public AbstractBitmap getReconstructed() {
		if (this.hasAll()) {
			AbstractBitmap result = this.resultImage;
